var main,ground,obstacless;
var main_img,ground_img,obstacless_img;
var PLAY = 1;
var END = 0;
var gameState = PLAY;
...
function draw() {
  ...
  //obstaclesGroup.x = obstaclesGroup.x+10   
...
function reset(){
  ...
  gameOver.visible = false;
  restart.visible = false;
  obstaclesGroup.setLifetimeEach(0)//destroyEach();
  cloudsGroup.setLifetimeEach(0)//destroyEach();
